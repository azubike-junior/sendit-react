				...
				<div className="signinContainer">
					<div className="row">
						<div className="col-md-6">
							...
							{this.props.verificationMsg && <div className="alert alert-success alert-dismissible fade show" role="alert">
								...
								<form onSubmit={this.handleSubmit}>
									...
									<div className='form-group'>
										...
										<input
											...
											required={true}
										/>
										<p className='text-right forget'><Link to='/forget_Password'>forget your password?</Link> </p>
